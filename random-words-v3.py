...
for i in range(random_count):
    ...
    # Do not set a random rotation – we'll make them face the camera via constraints.
...
# Position the camera and orient it to look at the center
...
print("Camera positioned for render.")
...
# Apply the constraint to all text objects in both collections.
for coll in [random_collection, tunnel_collection]:
    for obj in coll.objects:
        ...
        track.target = cam
        # Here, the text's local Z-axis will point toward the camera,
        # and its local Y-axis will be kept up.
